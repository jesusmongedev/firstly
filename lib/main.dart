            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: const Text(
                    'Oeschunen Lake Capground',
                    style: TextStyle(fontWeight: FontWeight.bold),
                  ),
                ),
                Text(
                  'Kanderstegm Swizerland',
                  style: TextStyle(
...
class _FavoriteWidgetState extends State<FavoriteWidget> {
  ...
  IconData get _favoriteIcon {
    return _isFavorited ? Icons.star : Icons.star_border;
  }
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          child: IconButton(
            padding: const EdgeInsets.all(0),
            icon: Icon(_favoriteIcon, color: Colors.red[500]),
...
// List<ButtonColumn> buttonColumns = [
